...
/* ============================================================
 *  8×8 Bitmap Font — Full ASCII printable set (95 chars)
 *  1bpp format: each byte is one row, MSB = leftmost pixel
 *  Characters: space (0x20) through tilde (0x7E)
 *
 *  Generated from a clean pixel font designed for GBA.
 *  Each character is carefully hand-crafted at 8×8 resolution.
 * ============================================================ */

const u8 font_data[FONT_CHARS][8] = {
    /* 0x20: Space */
    ...
    /* 0x25: % */
    { 0xC6, 0xCC, 0x18, 0x30, 0x60, 0xC6, 0x00, 0x00 },
    ...
    /* 0x35: 5 */
    { 0xFE, 0xC0, 0xFC, 0x06, 0xC6, 0xC6, 0x7C, 0x00 },
    ...
    /* 0x74: t */
    { 0x30, 0x30, 0x78, 0x30, 0x30, 0x36, 0x1C, 0x00 },
